...
MovementManager::Create()
{
    ...
    std::function UpdateFunc = [time](Game::WorldTransform& t, Movement& move) -> void
    {
    ...
    Game::RegisterUpdateFunction(Game::GetWorld(WORLD_DEFAULT), "MovementManager.UpdateMovement"_atm, UpdateFunc);
